...
SECRET_KEY = "django-insecure-ahoe@-yxrer9l2w#!8fw-^#u#ktf^b*a93psx=!m$p6+3bvo-@"
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_PERMISSION_CLASSES": [
        "rest_framework.permissions.AllowAny",  # 開發階段先設為所有人可存取
    ],
}

# CORS 設定（允許前端跨域請求）
CORS_ALLOW_ALL_ORIGINS = True  # 開發階段設為 True
